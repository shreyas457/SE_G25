...
const SignupPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      setFormData({ name: "", email: "", password: "", agreedToTerms: false });
      
      // Optionally redirect to signin page after success
      setTimeout(() => {
                    ...
                    >
                      <div className="relative">
                        ...
                        <div className="box mr-4 mt-1 flex h-5 w-5 items-center justify-center rounded border border-body-color border-opacity-20 dark:border-white dark:border-opacity-10">
                          <span className={formData.agreedToTerms ? "opacity-100" : "opacity-0"}>
                            <svg
                              width="11"
                              height="8"
                              viewBox="0 0 11 8"
