...
function p(t2) {
  return (
    !!l && !!u && u.brands.some(({ brand: e2 }) => e2 && -1 != e2.indexOf(t2))
  );
}
function g(e2) {
  var n2;
  return (
    ((n2 = t.navigator) && (n2 = n2.userAgent)) || (n2 = ""),
    -1 != n2.indexOf(e2)
  );
}
function m() {
...
function k(t2) {
  if (!T) {
    ...
    var n2 = Array(Math.floor(t2.length / 3)),
      r2 = e2[64] || "";
    let c2 = 0,
      h2 = 0;
    ...
    switch (((a2 = 0), (o2 = r2), t2.length - c2)) {
      ...
      case 1:
        ((t2 = t2[c2]),
          (n2[h2] = e2[t2 >> 2] + e2[((3 & t2) << 4) | (a2 >> 4)] + o2 + r2));
    }
    return n2.join("");
  }
  ...
  return (
    (e2 += String.fromCharCode.apply(null, n2 ? t2.subarray(n2) : t2)),
    btoa(e2)
  );
}
var S = /[-_.]/g;
...
function B(t2) {
  ...
  var e2 = t2.T;
  return null ==
    (e2 = null == e2 || M(e2) ? e2 : "string" == typeof e2 ? L(e2) : null)
    ? e2
    : (t2.T = e2);
}
var U = class {
  ...
  if (((t2 >>>= 0), 2097151 >= (e2 >>>= 0)))
    ...
    W()
      ...
      : ((t2 =
        ...
        (n2 += 8147497 * e2),
        (e2 *= 2),
        1e7 <= t2 && ((n2 += Math.floor(t2 / 1e7)), (t2 %= 1e7)),
        1e7 <= n2 && ((e2 += Math.floor(n2 / 1e7)), (n2 %= 1e7)),
        (n2 = e2 + nt(n2) + nt(t2)));
  return n2;
}
function nt(t2) {
...
function rt() {
  var t2 = $,
    e2 = q;
  if (2147483648 & e2)
    if (W()) t2 = "" + ((BigInt(0 | e2) << BigInt(32)) | BigInt(t2 >>> 0));
    else {
...
function it(t2) {
  if (16 > t2.length) J(Number(t2));
    ...
    ((t2 = BigInt(t2)),
      ($ = Number(t2 & BigInt(4294967295)) >>> 0),
      (q = Number((t2 >> BigInt(32)) & BigInt(4294967295))));
  else {
    const e2 = +("-" === t2[0]);
    q = $ = 0;
    const n2 = t2.length;
    ...
    return (
      ...
      255 == n2
        ? t2
          ...
          : (1 / 0) * e2
        : 0 == n2
          ? e2 * Math.pow(2, -149) * t2
          : e2 * Math.pow(2, n2 - 150) * (t2 + Math.pow(2, 23))
    );
  }
  C() {
    return this.m();
...
function yt(t2, e2, n2) {
  ...
  if (
    (0 >= o2 &&
      ((t2.g.l = s2), n2(e2, t2, void 0, void 0, void 0), (o2 = s2 - t2.g.g)),
    o2)
  )
    throw Error(
      `Message parsing ended unexpectedly. Expected to read ${i2} bytes, instead read ${i2 - o2} bytes, either the data ended unexpectedly or the message misreported its own length`
    );
...
function vt(t2) {
  ...
  if (((t2 = t2.h), o)) {
    ...
    ((c2 = s) || (c2 = s = new TextDecoder("utf-8", { fatal: true })),
      (t2 = a2 + e2),
      (h2 = 0 === a2 && t2 === h2.length ? h2 : h2.subarray(a2, t2)));
    try {
      var u2 = c2.decode(h2);
    } catch (t3) {
      if (void 0 === i) {
          ...
          : 240 > l2
            ? u2 >= e2 - 1
              ...
              : ((i2 = t2[u2++]),
                ...
                128 != (192 & (h2 = t2[u2++]))
                  ? (u2--, n())
                  : a2.push(((15 & l2) << 12) | ((63 & i2) << 6) | (63 & h2)))
            : 244 >= l2
              ? u2 >= e2 - 2
                ? n()
                : ((i2 = t2[u2++]),
              ...
              : n(),
        8192 <= a2.length && ((s2 = r(s2, a2)), (a2.length = 0)));
    }
    u2 = r(s2, a2);
  }
  return u2;
...
function se(t2, e2, n2) {
  ...
  return (
    !!(1 & r2) ||
    (!(!e2 || !(Array.isArray(e2) ? e2.includes(n2) : e2.has(n2))) &&
      (Yt(t2, 1 | r2), true))
  );
}
var oe;
...
function ye(t2) {
  return null == t2
    ? t2
    : "boolean" == typeof t2 || "number" == typeof t2
      ? !!t2
      : void 0;
}
...
function Ae(t2, e2) {
  ...
  return Number.isSafeInteger(n2)
    ? String(n2)
    : (-1 !== (n2 = t2.indexOf(".")) && (t2 = t2.substring(0, n2)),
      e2 && (it(t2), (t2 = rt())),
      t2);
}
function Te(t2) {
...
var Le =
  "function" == typeof Symbol && "symbol" == typeof Symbol() ? Symbol() : "di";
function Me(t2) {
  return t2;
}
function Oe(t2, e2, n2) {
  if (e2) {
    ...
    "string" == typeof e2
      ...
      : r2
        ? ((e2 = Math.trunc(e2)),
          !r2 || Number.isSafeInteger(e2)
            ? (r2 = String(e2))
            : (J(e2), (r2 = rt())))
        : (r2 = Ee(e2));
  } else r2 = Te(t2);
  return "string" == typeof (n2 = null == (t2 = r2) ? (n2 ? 0 : void 0) : t2) &&
    ((r2 = +n2), Number.isSafeInteger(r2))
    ? r2
    : n2;
}
var Pe;
...
var Ge = Ue
  ? (Object.setPrototypeOf(Ne.prototype, Map.prototype),
    Object.defineProperties(Ne.prototype, {
      size: { value: 0, configurable: true, enumerable: true, writable: true },
    }),
    Ne)
  : class extends Map {
      constructor() {
...
var Ve = class extends Ge {
  constructor(t2, e2, n2 = Me, r2 = Me) {
    ...
    ((i2 |= 64),
      ...
      (this.O = e2),
      (this.J = n2 || Me),
      (this.S = this.O ? ze : r2 || Me));
    for (let s2 = 0; s2 < t2.length; s2++) {
      const o2 = t2[s2],
        a2 = n2(o2[0], false, true);
      let c2 = o2[1];
      (e2
        ? void 0 === c2 && (c2 = null)
        : (c2 = r2(o2[1], false, true, void 0, void 0, i2)),
        super.set(a2, c2));
    }
  }
  ka(t2 = We) {
  ...
  set(t2, e2) {
    return (
      je(this),
      null == (t2 = this.J(t2, true, false))
        ? this
        : null == e2
          ? (super.delete(t2), this)
          : super.set(t2, this.S(e2, true, true, this.O, false, this.I))
    );
  }
  Oa(t2) {
    ...
    ((t2 = t2[1]),
      (t2 = this.O
        ? void 0 === t2
          ? null
          : t2
        : this.S(t2, false, true, void 0, false, this.I)),
      super.set(e2, t2));
  }
  has(t2) {
  ...
  get(t2) {
    ...
    if (void 0 !== e2) {
      var n2 = this.O;
      return n2
        ? ((n2 = this.S(e2, false, true, n2, this.ra, this.I)) !== e2 &&
            super.set(t2, n2),
          n2)
        : e2;
    }
...
function He(t2, e2, n2, r2, i2, s2) {
  if (null != t2) {
    if (Array.isArray(t2))
      t2 =
        i2 && 0 == t2.length && 1 & Xt(t2)
          ? void 0
          : s2 && 2 & Xt(t2)
            ? t2
            : Ye(t2, e2, n2, void 0 !== r2, i2, s2);
    else if (ne(t2)) {
      const o2 = {};
...
function qe(t2, e2, n2 = Jt) {
  if (null != t2) {
    ...
    if (Array.isArray(t2)) {
      ...
      return 2 & r2
        ? t2
        : (e2 && (e2 = 0 === r2 || (!!(32 & r2) && !(64 & r2 || !(16 & r2)))),
          e2
            ? (Yt(t2, -12293 & (34 | r2)), t2)
            : Ye(t2, qe, 4 & r2 ? Jt : n2, true, false, true));
    }
    return (
      t2.P === Qt
        ? ((n2 = t2.s), (t2 = 2 & (r2 = Ht(n2)) ? t2 : Je(t2, n2, r2, true)))
        : t2 instanceof Ve &&
          ((n2 = $t(t2.R(qe))), (t2 = new Ve(n2, t2.O, t2.J, t2.S))),
      t2
    );
  }
}
...
function rn(t2, e2, n2, r2, i2) {
  ...
  return (
    (t2[n2 + (+!!(512 & e2) - 1)] = r2),
    256 & e2 && n2 in (t2 = t2[t2.length - 1]) && delete t2[n2],
    e2
  );
}
...
function cn(t2, e2, n2) {
  ...
  return (
    h2 ||
      ((n2 = 1 === r2) && (o2 = Wt(o2, 2, true)),
      o2 !== a2 && Yt(s2, o2),
      (n2 || c2) && Object.freeze(s2)),
    2 === r2 &&
      c2 &&
      ((s2 = Nt(s2)), (o2 = Tn(o2, i2, false)), Yt(s2, o2), rn(t2, i2, e2, s2)),
    s2
  );
}
var hn;
...
function fn(t2, e2, n2) {
  {
    ...
    if ((ce(a2), null == n2)) rn(o2, a2, e2);
      ...
      var r2 = (t2 = Xt(n2)),
        i2 = !!(2 & t2) || Object.isFrozen(n2),
        s2 = !i2 && false;
      if (!(4 & t2)) {
        ((t2 = 21),
          i2 && ((n2 = Nt(n2)), (r2 = 0), (t2 = Tn(t2, a2, true))),
          (i2 = !!(4 & t2) && !!(4096 & t2)));
...
function vn(t2, e2, n2, r2) {
  ...
  const s2 = en(t2, i2, n2, r2);
  return (
    (e2 = Fe(s2, e2, false, i2)) !== s2 && null != e2 && rn(t2, i2, n2, e2, r2),
    e2
  );
}
...
function wn(t2, e2, n2, r2, i2, s2, o2) {
  ...
  if (!f2) {
    ...
    (o3 < s3 && (g2.length = o3),
      ...
      (u2 = Wt(u2, 8, r3)),
      Yt(g2, u2),
      l2 && !c2 && (Object.freeze(h2), (p2 = true)));
  }
  ...
  return (
    p2 ||
      (a2
        ? (u2 = Wt(u2, !h2.length || (16 & u2 && (!f2 || d2)) ? 2 : 2048, true))
        : s2 || (u2 = Wt(u2, 32, false)),
      u2 !== n2 && Yt(h2, u2),
      a2 && (Object.freeze(h2), (p2 = true))),
    i2 &&
      p2 &&
      ((h2 = Nt(h2)), (u2 = Tn(u2, e2, s2)), Yt(h2, u2), rn(t2, e2, r2, h2)),
    h2
  );
}
...
function An(t2, e2, n2, r2) {
  ...
  let i2 = Ht(t2);
  (ce(i2),
    (n2 = mn(t2, i2, n2)) && n2 !== e2 && null != r2 && (i2 = rn(t2, i2, n2)),
    rn(t2, i2, e2, r2));
}
function Tn(t2, e2, n2) {
  return (
    (t2 = Wt(t2, 2, !!(2 & e2))),
    (t2 = Wt(t2, 32, !!(32 & e2) && n2)),
    Wt(t2, 2048, false)
  );
}
function kn(t2, e2, n2) {
  ...
  (ce(r2),
    (t2 = wn(t2, r2, e2, 1, 2)),
    (e2 = null != n2 ? n2 : new e2()),
    t2.push(e2),
    2 & Xt(e2.s) ? zt(t2, 8) : zt(t2, 16));
}
function Sn(t2, e2) {
  return we(tn(t2, e2));
}
  ...
  if (null != n2) {
    if ("boolean" != typeof n2)
      throw (
        (t2 = typeof n2),
        Error(
          `Expected boolean but got ${"object" != t2 ? t2 : n2 ? (Array.isArray(n2) ? "array" : t2) : "null"}: ${n2}`
        )
      );
    n2 = !!n2;
  }
...
function Pn(t2, e2, n2) {
  if (null != n2 && "number" != typeof n2)
    throw Error(
      `Value of float/double field must be a number, found ${typeof n2}: ${n2}`
    );
  nn(t2, e2, n2);
}
...
var Cn = class {
  ...
  l() {
    var t2 = no;
    return t2.g
      ? t2.l(this, t2.g, t2.h, true, 2)
      : t2.l(this, t2.h, t2.defaultValue, true);
  }
  clone() {
    const t2 = this.s;
...
function Rn(t2, e2, n2) {
  ...
  if (r2 && re) {
    ...
    for (let e3 = 0; e3 < r2.length; e3++) {
      ...
      if (h2 < t2) {
        ...
        if (!c2) {
          var l2 = void 0;
          s2.length && ne((l2 = s2[s2.length - 1]))
            ? (c2 = l2)
            : s2.push((c2 = {}));
        }
        ((u2 = c2[h2]),
    ...
    t: {
      ...
      for (var g2 in ((s2 = {}), (n2 = false), p2))
        ((t2 = p2[g2]),
          Array.isArray(t2) &&
            ((a2 = t2),
            ((!H && se(t2, r2, +g2)) || (!X && ee(t2) && 0 === t2.size)) &&
              (t2 = null),
            t2 != a2 && (n2 = true)),
          null != t2 ? (s2[g2] = t2) : (n2 = true));
      if (n2) {
        for (let t3 in s2) {
          p2 = s2;
          break t;
  ...
  for (
    ...
    d2 = true;
  return f2 || d2
    ? ((e2 = o2 ? e2 : Array.prototype.slice.call(e2, 0, c2)),
      o2 && (e2.length = c2),
      p2 && e2.push(p2),
      e2)
    : e2;
      ...
      : (t3, e3) => {
          for (; gt(e3) && 4 != e3.h; ) {
            ...
            (s2 && s2(e3, t3, i3)) ||
              ...
              s2.ea
                ? (s2 = void 0)
                : ((o2 = s2.g.g - i3), (s2.g.g = i3), (s2 = ft(s2.g, o2))),
              (i3 = t3),
              s2 &&
                (le || (le = Symbol()),
                (o2 = i3[le]) ? o2.push(s2) : (i3[le] = [s2])));
          }
...
function Hn(t2) {
  ...
  if (!(e2 = Kn(t2, (t2[zn] = {}), Xn, Xn, Wn)).ja && !e2.ia) {
    ...
    n2
      ? ((e2 = Re(t2[0]) === Ie),
        (e2 = t2[zn] = e2 ? Vn || (Vn = { K: Re(true) }) : jn || (jn = {})))
      : (e2.Ja = true);
  }
  return e2;
}
...
function Kn(t2, e2, n2, r2, i2 = Yn) {
  ...
  o2 &&
    ...
    ((e2.fa = o2),
    "function" == typeof (o2 = t2[++s2]) &&
      ((e2.g = o2), (e2.h = t2[++s2]), (o2 = t2[++s2])));
  const a2 = {};
...
function Qn(t2, e2) {
  ...
  const i2 = t2.h;
  return (t3, s2, o2) =>
    i2(t3, s2, o2, r2 || (r2 = tr(e2).K), n2 || (n2 = qn(e2)));
}
function tr(t2) {
  let e2 = t2[Jn];
  return (
    e2 ||
    ((e2 = Kn(t2, (t2[Jn] = {}), Zn, Qn)),
    er in t2 && Jn in t2 && (t2.length = 0),
    e2)
  );
}
var er = Symbol();
...
function rr(t2, e2, n2) {
  ...
  let i2, s2;
  return (t3, o2, a2) =>
    r2(t3, o2, a2, s2 || (s2 = ir(e2).K), i2 || (i2 = Nn(e2)), n2);
}
function ir(t2) {
  let e2 = t2[er];
  return (
...
function or(t2, e2, n2) {
  ...
  if (256 & r2) {
    ...
    for (let t3 in r2)
      ((i2 = +t3),
        Number.isNaN(i2) ||
          (null != (s2 = r2[t3]) && (a2 = sr(n2, i2)) && a2(e2, s2, i2)));
  }
...
var lr = hr(
  function (t2, e2, n2, r2, i2) {
    return (
      2 === t2.h &&
      ((t2 = yt(t2, De([void 0, void 0], r2), i2)),
      ce((r2 = Ht(e2))),
      (i2 = en(e2, r2, n2)) instanceof Ve
        ? 0 != (2 & i2.I)
          ? ((i2 = i2.R()).push(t2), rn(e2, r2, n2, i2))
          : i2.Oa(t2)
        : Array.isArray(i2)
          ? (2 & Xt(i2) && rn(e2, r2, n2, (i2 = ln(i2))), i2.push(t2))
          : rn(e2, r2, n2, [t2]),
      true)
    );
  },
...
function fr(t2, e2, n2) {
  ...
  null != e2 &&
    ("string" == typeof e2 && kt(e2),
    null != e2 &&
      (It(t2, n2, 0),
      "number" == typeof e2
        ? ((t2 = t2.g), J(e2), Ft(t2, $, q))
        : ((n2 = kt(e2)), Ft(t2.g, n2.h, n2.g))));
}
...
function mr(t2, e2, n2, r2, i2) {
  Bt(
    t2,
    n2,
    e2 instanceof Cn ? e2.s : Array.isArray(e2) ? De(e2, r2) : void 0,
    i2
  );
}
function yr(t2, e2, n2) {
  null !=
    (e2 =
      null == e2 || "string" == typeof e2 || M(e2) || e2 instanceof U
        ? e2
        : void 0) && Dt(t2, n2, z(e2).buffer);
}
function vr(t2, e2, n2) {
  return (
    (5 === t2.h || 2 === t2.h) &&
    ((e2 = sn(e2, Ht(e2), n2, 2, false)),
    2 == t2.h ? wt(t2, dt.prototype.B, e2) : e2.push(t2.g.B()),
    true)
  );
}
var _r;
var wr = ar(
      ...
      ur(
        ...
        2047 == s2
          ? t2
            ...
            : (1 / 0) * r2
          : 0 == s2
            ? r2 * Math.pow(2, -1074) * t2
            : r2 * Math.pow(2, s2 - 1075) * (t2 + 4503599627370496)
      ),
      true
    );
  },
  function (t2, e2, n2) {
    null != (e2 = me(e2)) &&
      (It(t2, n2, 1),
      (t2 = t2.g),
      (n2 = K || (K = new DataView(new ArrayBuffer(8)))).setFloat64(
        0,
        +e2,
        true
      ),
      ($ = n2.getUint32(0, true)),
      (q = n2.getUint32(4, true)),
      Ot(t2, $),
      Ot(t2, q));
  }
);
...
var kr = ar(function (t2, e2, n2) {
  return (
    0 === t2.h && (ur(e2, n2, 0 === (t2 = ct(t2.g, tt)) ? void 0 : t2), true)
  );
}, fr);
var Sr = ar(
  function (t2, e2, n2) {
  ...
  function (t2, e2, n2) {
      ...
      if (_e(e2)) {
        if ("string" == typeof e2) {
          ...
          Number.isSafeInteger(r2)
            ? (e2 = String(r2))
            : (-1 !== (r2 = e2.indexOf(".")) && (e2 = e2.substring(0, r2)),
              it(e2),
              (e2 = et($, q)));
          break t;
        }
    ...
    null != e2 &&
      ("string" == typeof e2 && Et(e2),
      null != e2 &&
        (It(t2, n2, 0),
        "number" == typeof e2
          ? ((t2 = t2.g), J(e2), Ft(t2, $, q))
          : ((n2 = Et(e2)), Ft(t2.g, n2.h, n2.g))));
  }
);
...
var Fr = cr(
  function (t2, e2, n2) {
    return (
      (0 === t2.h || 2 === t2.h) &&
      ((e2 = sn(e2, Ht(e2), n2, 2, false)),
      2 == t2.h ? wt(t2, dt.prototype.m, e2) : e2.push(t2.g.m()),
      true)
    );
  },
  function (t2, e2, n2) {
...
var Or = ar(function (t2, e2, n2) {
  return (
    0 === t2.h && (ur(e2, n2, false === (t2 = ht(t2.g)) ? void 0 : t2), true)
  );
}, pr);
var Pr = cr(
  function (t2, e2, n2) {
...
_r = new Ut(
  function (t2, e2, n2, r2, i2) {
    ...
    return (
      (s2 = Ht(e2)),
      4 & Xt(o2) &&
        ((o2 = Nt(o2)), Yt(o2, -2079 & (1 | Xt(o2))), rn(e2, s2, n2, o2)),
      o2.push(r2),
      yt(t2, r2, i2),
      true
    );
  ...
  function (t2, e2, n2, r2, i2) {
    if (Array.isArray(e2))
      for (let s2 = 0; s2 < e2.length; s2++) mr(t2, e2[s2], n2, r2, i2);
  },
  true,
  true
);
var Br = hr(function (t2, e2, n2, r2, i2, s2) {
  ...
  return (
    ce(o2),
    (s2 = mn(e2, o2, s2)) && n2 !== s2 && rn(e2, o2, s2),
    yt(t2, (e2 = yn(e2, r2, n2)), i2),
    true
  );
}, mr);
...
var Nr = cr(
  function (t2, e2, n2) {
    return (
      (0 === t2.h || 2 === t2.h) &&
      ((e2 = sn(e2, Ht(e2), n2, 2, false)),
      2 == t2.h ? wt(t2, dt.prototype.j, e2) : e2.push(t2.g.j()),
      true)
    );
  },
  function (t2, e2, n2) {
...
var Gr = ar(
  ...
  function (t2, e2, n2) {
    null != (e2 = we(e2)) &&
      ((e2 = parseInt(e2, 10)), It(t2, n2, 0), Mt(t2.g, e2));
  }
);
var jr = cr(
  function (t2, e2, n2) {
    return (
      (0 === t2.h || 2 === t2.h) &&
      ((e2 = sn(e2, Ht(e2), n2, 2, false)),
      2 == t2.h ? wt(t2, dt.prototype.C, e2) : e2.push(t2.g.m()),
      true)
    );
  },
  function (t2, e2, n2) {
...
var Hr = [
  ...
  ar(
    function (t2, e2, n2) {
      return (
        2 === t2.h && (ur(e2, n2, (t2 = _t(t2)) === D() ? void 0 : t2), true)
      );
    },
    function (t2, e2, n2) {
      if (null != e2) {
        if (e2 instanceof Cn) {
          const r2 = e2.Qa;
          return void (
            r2 && ((e2 = r2(e2)), null != e2 && Dt(t2, n2, z(e2).buffer))
          );
        }
...
ri[336783863] = [
  ...
  -1,
  xr,
  [0, [1, 2, 3, 4, 5], Br, ti, Br, Jr, Br, Zr, Br, ei, Br, Kr],
  Yr,
];
var si = [0, Ir, Or];
    ...
    g() {
      ...
      return (
        (t2 = (function (t3, e3, n3) {
          ...
          return (
            s2 || (64 & Xt(n3) ? zt(n3, 32) : 32 & e3 && jt(n3, 32)),
            rn(t3, e3, 2, (r2 = new Ve(n3, r2, Oe, void 0)), false),
            r2
          );
        })(t2, e2, en(t2, e2, 2))),
        null == t2 || (!n2 && eo && (t2.ra = true)),
        (n2 = t2)
      );
    }
  }
...
function yo(t2) {
  ...
  if (
    ((e2 = (_a2 = _n(t2, Ui, 4)) == null ? void 0 : _a2.h()) &&
      (s2.boundingBox = {
        originX: Sn(e2, 1) ?? 0,
        originY: Sn(e2, 2) ?? 0,
        width: Sn(e2, 3) ?? 0,
    ...
    (_b = _n(t2, Ui, 4)) == null ? void 0 : _b.g().length)
  )
...
function Mo(t2, e2, n2) {
  ...
  if (
    ...
    !(n2 = t2.i.canvas.getContext("webgl2") || t2.i.canvas.getContext("webgl")))
  )
    throw Error(
  ...
  return (
    ...
    e2.videoWidth
      ? ((n2 = e2.videoWidth), (e2 = e2.videoHeight))
      : e2.naturalWidth
        ? ((n2 = e2.naturalWidth), (e2 = e2.naturalHeight))
        : ((n2 = e2.width), (e2 = e2.height)),
    !t2.l ||
      (n2 === t2.i.canvas.width && e2 === t2.i.canvas.height) ||
      ((t2.i.canvas.width = n2), (t2.i.canvas.height = e2)),
    [n2, e2]
  );
}
...
function Ro(t2, e2) {
  ...
  ("string" == typeof e2
    ? (nn(n2, 2, Se(e2)), nn(n2, 1))
    : e2 instanceof Uint8Array && (nn(n2, 1, ie(e2, false, false)), nn(n2, 2)),
    En(t2.baseOptions, 0, 1, n2));
}
function Do(t2) {
  try {
...
function Uo(t2, e2) {
  ((t2.B = new di()),
    ui(t2.B, "PassThroughCalculator"),
    li(t2.B, "free_memory"),
    fi(t2.B, "free_memory_unused_out"),
    wi(e2, "free_memory"),
    _i(e2, t2.B));
}
function No(t2, e2) {
...
var jo = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (
        !(
          ((_c2 = _n(this.baseOptions, ms, 1)) == null ? void 0 : _c2.g()) ||
          ((_d = _n(this.baseOptions, ms, 1)) == null ? void 0 : _d.h()) ||
      ...
      if (
        ((function (t3, e4) {
          ...
          ("delegate" in e4 &&
            ("GPU" === e4.delegate
              ? ((e4 = n2), (r2 = new qr()), An(e4, 2, gs, r2))
              : ((e4 = n2), (r2 = new Qr()), An(e4, 4, gs, r2))),
            En(t3.baseOptions, 0, 3, n2));
        })(this, e3),
        e3.modelAssetPath)
      )
...
function Wo(t2, e2, n2) {
  const r2 = t2.h;
  if (
    ((n2 = Vo(r2.createShader(n2), "Failed to create WebGL shader")),
...
function Xo(t2, e2) {
  const n2 = t2.h,
    r2 = Vo(n2.createVertexArray(), "Failed to create vertex array");
  n2.bindVertexArray(r2);
  const i2 = Vo(n2.createBuffer(), "Failed to create buffer");
  (n2.bindBuffer(n2.ARRAY_BUFFER, i2),
    n2.enableVertexAttribArray(t2.u),
    n2.vertexAttribPointer(t2.u, 2, n2.FLOAT, false, 0, 0),
    n2.bufferData(
      n2.ARRAY_BUFFER,
  ...
  return (
    ...
    n2.enableVertexAttribArray(t2.B),
    n2.vertexAttribPointer(t2.B, 2, n2.FLOAT, false, 0, 0),
    n2.bufferData(
      n2.ARRAY_BUFFER,
      new Float32Array(
...
function Yo(t2, e2, n2, r2) {
  if ((Ho(t2, e2), !t2.g)) {
    const e3 = t2.h;
    if (
      ((t2.g = Vo(e3.createProgram(), "Failed to create WebGL program")),
      (t2.C = Wo(
        t2,
      ...
      e3.linkProgram(t2.g),
      !e3.getProgramParameter(t2.g, e3.LINK_STATUS))
    )
      throw Error(
        `Error during program linking: ${e3.getProgramInfoLog(t2.g)}`
      );
    ((t2.u = e3.getAttribLocation(t2.g, "aVertex")),
      (t2.B = e3.getAttribLocation(t2.g, "aTex")));
  }
  return (
    n2
      ? (t2.m || (t2.m = Xo(t2, true)), (n2 = t2.m))
      : (t2.j || (t2.j = Xo(t2, false)), (n2 = t2.j)),
    e2.useProgram(t2.g),
    n2.bind(),
    (t2 = r2()),
...
function Ko(t2, e2, n2) {
  (Ho(t2, e2),
    t2.l || (t2.l = Vo(e2.createFramebuffer(), "Failed to create framebuffe.")),
    e2.bindFramebuffer(e2.FRAMEBUFFER, t2.l),
...
var qo = class {
  close() {
    if (this.g) {
      const t2 = this.h;
      (t2.deleteProgram(this.g),
        t2.deleteShader(this.C),
        t2.deleteShader(this.v));
    }
...
function Jo(t2, e2) {
  switch (e2) {
    ...
    case 2:
      return t2.g.find(
        (t3) => "undefined" != typeof WebGLTexture && t3 instanceof WebGLTexture
      );
    default:
...
function ra(t2) {
  ((t2 = ta(t2)).texParameteri(
    t2.TEXTURE_2D,
    t2.TEXTURE_WRAP_S,
    t2.CLAMP_TO_EDGE
  ),
    t2.texParameteri(t2.TEXTURE_2D, t2.TEXTURE_WRAP_T, t2.CLAMP_TO_EDGE),
    t2.texParameteri(t2.TEXTURE_2D, t2.TEXTURE_MIN_FILTER, t2.NEAREST),
    t2.texParameteri(t2.TEXTURE_2D, t2.TEXTURE_MAG_FILTER, t2.NEAREST));
}
function ia(t2) {
  const e2 = ta(t2);
  ...
  return (
    n2
      ...
      : ((n2 = Vo(e2.createTexture(), "Failed to create texture")),
        t2.g.push(n2),
        (t2.m = true),
        e2.bindTexture(e2.TEXTURE_2D, n2),
        ra(t2)),
...
var aa = class {
  ...
  Ca() {
    return (
      (e2 = Jo((t2 = this), 0)) ||
        ((e2 = Zo(t2)),
        (e2 = new Uint8Array(e2.map((t3) => 255 * t3))),
        t2.g.push(e2)),
      e2
    );
    var t2, e2;
      ...
      if (e2 instanceof Uint8Array) n2 = new Uint8Array(e2);
          ...
          throw Error(`Type is not supported: ${e2}`);
        {
          ...
          (t3.activeTexture(t3.TEXTURE1),
            (n2 = Vo(t3.createTexture(), "Failed to create texture")),
...
var pa = class {
  ...
  wa(t2, e2) {
    if (t2) {
      ...
      var r2 = n2.canvas,
        i2 = 0;
      for (const s2 of t2)
        ((n2.fillStyle = la(e2.fillColor, { index: i2, from: s2 })),
          (n2.strokeStyle = la(e2.color, { index: i2, from: s2 })),
          (n2.lineWidth = la(e2.lineWidth, { index: i2, from: s2 })),
          (t2 = new Path2D()).arc(
            s2.x * r2.width,
            s2.y * r2.height,
            la(e2.radius, { index: i2, from: s2 }),
            0,
            2 * Math.PI
          ),
          n2.fill(t2),
  ...
  va(t2, e2, n2) {
    if (t2 && e2) {
      ...
      for (const o2 of e2) {
        ...
        (e2 &&
          a2 &&
          ((r2.strokeStyle = la(n2.color, { index: s2, from: e2, to: a2 })),
          (r2.lineWidth = la(n2.lineWidth, { index: s2, from: e2, to: a2 })),
  ...
  ua(t2, e2) {
    ...
    ((e2 = ua(e2)),
      n2.save(),
      n2.beginPath(),
      (n2.lineWidth = la(e2.lineWidth, {})),
      (n2.strokeStyle = la(e2.color, {})),
      (n2.fillStyle = la(e2.fillColor, {})),
  ...
  close() {
    var _a2, _b;
    ((_a2 = this.h) == null ? void 0 : _a2.close(),
      (this.h = void 0),
      (_b = this.l) == null ? void 0 : _b.close(),
      (this.l = void 0));
  }
};
function ga(t2, e2) {
  switch (e2) {
    ...
    case 1:
      return t2.g.find(
        (t3) => "undefined" != typeof ImageBitmap && t3 instanceof ImageBitmap
      );
    case 2:
      return t2.g.find(
        (t3) => "undefined" != typeof WebGLTexture && t3 instanceof WebGLTexture
...
function wa(t2) {
  ((t2 = va(t2)).texParameteri(
    t2.TEXTURE_2D,
    t2.TEXTURE_WRAP_S,
    t2.CLAMP_TO_EDGE
  ),
    t2.texParameteri(t2.TEXTURE_2D, t2.TEXTURE_WRAP_T, t2.CLAMP_TO_EDGE),
    t2.texParameteri(t2.TEXTURE_2D, t2.TEXTURE_MIN_FILTER, t2.LINEAR),
    t2.texParameteri(t2.TEXTURE_2D, t2.TEXTURE_MAG_FILTER, t2.LINEAR));
}
function ba(t2) {
  const e2 = va(t2);
  (e2.viewport(0, 0, t2.width, t2.height), e2.activeTexture(e2.TEXTURE0));
...
((pa.prototype.close = pa.prototype.close),
  ...
  (pa.lerp = function (t2, e2, n2, r2, i2) {
    return fa(
  ...
  ((Fa = class {
    constructor(t2, e2) {
      ((this.l = true),
        ...
        void 0 !== e2
          ? (this.i.canvas = e2)
          : "undefined" == typeof OffscreenCanvas || xo()
            ? (console.warn(
  ...
  if (t2.da) {
    ...
    if (n2 == null ? void 0 : n2.rotationDegrees) {
      ...
      if (
        ...
        0 != (n2 == null ? void 0 : n2.rotationDegrees) % 180)
      ) {
        const [t3, r3] =
          void 0 !== e2.videoWidth
            ? [e2.videoWidth, e2.videoHeight]
            : void 0 !== e2.naturalWidth
              ? [e2.naturalWidth, e2.naturalHeight]
              : [e2.width, e2.height];
        ((n2 = (Ln(s2, 3) * r3) / t3),
          (i2 = (Ln(s2, 4) * t3) / r3),
          Pn(s2, 4, n2),
...
function Ca(t2, e2, n2) {
  ...
  const i2 = e2.width,
    s2 = i2 * (e2 = e2.height);
  if (
    (r2 instanceof Uint8Array || r2 instanceof Float32Array) &&
    r2.length !== s2
  )
    throw Error("Unsupported channel count: " + r2.length / s2);
  return (
    (t2 = new aa([r2], false, t2.g.i.canvas, t2.U, i2, e2)),
    n2 ? t2.clone() : t2
  );
}
var Ra = class extends jo {
  ...
  l(t2, e2 = true) {
    if (
      ("runningMode" in t2 &&
        Mn(this.baseOptions, 2, !!t2.runningMode && "IMAGE" !== t2.runningMode),
...
var Da = class extends Ra {
  constructor(t2, e2) {
    (super(new La(t2, e2), "image_in", "norm_rect_in", false),
      (this.j = { detections: [] }),
      (this.h = new ws()),
      (t2 = new vs()),
      En(this.h, 0, 1, t2),
  ...
  m() {
    ...
    In(e2, Es, this.h);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"),
      li(n2, "IMAGE:image_in"),
      li(n2, "NORM_RECT:norm_rect_in"),
      fi(n2, "DETECTIONS:detections"),
      n2.o(e2),
      _i(t2, n2),
...
((Da.prototype.detectForVideo = Da.prototype.G),
  ...
  (Da.createFromModelPath = async function (t2, e2) {
...
var Ka = class extends Ra {
  constructor(t2, e2) {
    (super(new La(t2, e2), "image_in", "norm_rect", false),
      (this.j = {
        faceLandmarks: [],
        faceBlendshapes: [],
        facialTransformationMatrixes: [],
  ...
  o(t2) {
    return (
      "numFaces" in t2 && On(this.u, 4, t2.numFaces ?? 1),
      ...
      "minFacePresenceConfidence" in t2 &&
        Pn(this.v, 2, t2.minFacePresenceConfidence ?? 0.5),
  ...
  m() {
    ...
    In(e2, Os, this.h);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"),
      li(n2, "IMAGE:image_in"),
      li(n2, "NORM_RECT:norm_rect"),
      fi(n2, "NORM_LANDMARKS:face_landmarks"),
      n2.o(e2),
      _i(t2, n2),
      ...
      this.outputFacialTransformationMatrixes &&
        (bi(t2, "face_geometry"),
        fi(n2, "FACE_GEOMETRY:face_geometry"),
...
((Ka.prototype.detectForVideo = Ka.prototype.G),
  ...
  (Ka.createFromModelPath = function (t2, e2) {
...
var $a = class extends Ra {
  constructor(t2, e2) {
    (super(new La(t2, e2), "image_in", "norm_rect", true),
      (this.j = new Ps()),
      (t2 = new vs()),
      En(this.j, 0, 1, t2));
  }
  ...
  Pa(t2, e2, n2) {
    ...
    if (
      ((this.h = "function" == typeof e2 ? e2 : n2),
      Pa(this, t2, r2 ?? {}),
      !this.h)
    )
      return this.u;
  ...
  m() {
    ...
    In(e2, Is, this.j);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.face_stylizer.FaceStylizerGraph"),
      li(n2, "IMAGE:image_in"),
      li(n2, "NORM_RECT:norm_rect"),
      fi(n2, "STYLIZED_IMAGE:stylized_image"),
      n2.o(e2),
      _i(t2, n2),
      this.g.X("stylized_image", (t3, e3) => {
        var n3 = !this.h,
          r2 = t3.data,
          i2 = t3.width;
        ...
        if (r2 instanceof Uint8Array)
          if (r2.length === 3 * s2) {
            ...
            if (r2.length !== 4 * s2)
              throw Error("Unsupported channel count: " + r2.length / s2);
            r2 = new ImageData(
              new Uint8ClampedArray(r2.buffer, r2.byteOffset, r2.length),
              i2,
              t3
            );
          }
        ...
        ((i2 = new Ta([r2], false, false, this.g.i.canvas, this.U, i2, t3)),
          (this.u = n3 = n3 ? i2.clone() : i2),
          this.h && this.h(n3),
          Bo(this, e3));
      }),
...
(($a.prototype.stylize = $a.prototype.Pa),
  ...
  ($a.createFromModelPath = function (t2, e2) {
...
function Qa(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      ((r2 = e2 && null != Sn(n3, 1) ? Fn(Sn(n3, 1)) : -1),
        t2.push({
          score: Ln(n3, 2) ?? 0,
          index: r2,
          categoryName: xn(n3, 3) ?? "" ?? "",
          displayName: xn(n3, 4) ?? "" ?? "",
        }));
    n2.push(t2);
  }
...
var tc = class extends Ra {
  ...
  o(t2) {
    var _a2, _b, _c2, _d;
    if (
      (On(this.h, 3, t2.numHands ?? 1),
      "minHandDetectionConfidence" in t2 &&
        Pn(this.h, 2, t2.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t2 &&
        Pn(this.C, 4, t2.minTrackingConfidence ?? 0.5),
      ...
      var e2 = new Cs(),
        n2 = go(
          t2.cannedGesturesClassifierOptions,
          (_a2 = _n(this.j, Cs, 3)) == null ? void 0 : _a2.h()
        );
      (En(e2, 0, 2, n2), En(this.j, 0, 3, e2));
    } else
      void 0 === t2.cannedGesturesClassifierOptions &&
        ((_b = _n(this.j, Cs, 3)) == null ? void 0 : _b.g());
    return (
      t2.customGesturesClassifierOptions
        ? (En(
            ...
            (n2 = go(
              t2.customGesturesClassifierOptions,
              (_c2 = _n(this.j, Cs, 4)) == null ? void 0 : _c2.h()
            ))
          ),
          En(this.j, 0, 4, e2))
        : void 0 === t2.customGesturesClassifierOptions &&
          ((_d = _n(this.j, Cs, 4)) == null ? void 0 : _d.g()),
      this.l(t2)
    );
  }
  Ka(t2, e2) {
  ...
  m() {
    ...
    (wi(t2, "image_in"),
      wi(t2, "norm_rect"),
      bi(t2, "hand_gestures"),
      bi(t2, "hand_landmarks"),
      bi(t2, "world_hand_landmarks"),
      bi(t2, "handedness"));
    const e2 = new ni();
    In(e2, Ks, this.v);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"),
      li(n2, "IMAGE:image_in"),
      li(n2, "NORM_RECT:norm_rect"),
      fi(n2, "HAND_GESTURES:hand_gestures"),
      fi(n2, "LANDMARKS:hand_landmarks"),
      fi(n2, "WORLD_LANDMARKS:world_hand_landmarks"),
      fi(n2, "HANDEDNESS:handedness"),
      n2.o(e2),
      _i(t2, n2),
...
((tc.prototype.recognizeForVideo = tc.prototype.La),
  ...
  (tc.createFromModelPath = function (t2, e2) {
...
var nc = class extends Ra {
  ...
  o(t2) {
    return (
      "numHands" in t2 && On(this.h, 3, t2.numHands ?? 1),
      "minHandDetectionConfidence" in t2 &&
        Pn(this.h, 2, t2.minHandDetectionConfidence ?? 0.5),
      "minTrackingConfidence" in t2 &&
        Pn(this.j, 4, t2.minTrackingConfidence ?? 0.5),
      "minHandPresenceConfidence" in t2 &&
        Pn(this.u, 2, t2.minHandPresenceConfidence ?? 0.5),
      this.l(t2)
    );
  ...
  m() {
    ...
    In(e2, Ys, this.j);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"),
      li(n2, "IMAGE:image_in"),
      li(n2, "NORM_RECT:norm_rect"),
      fi(n2, "LANDMARKS:hand_landmarks"),
      fi(n2, "WORLD_LANDMARKS:world_hand_landmarks"),
...
((nc.prototype.detectForVideo = nc.prototype.G),
  ...
  (nc.createFromModelPath = function (t2, e2) {
...
var rc = class extends Ra {
  constructor(t2, e2) {
    (super(new La(t2, e2), "input_image", "norm_rect", true),
  ...
  m() {
    ...
    In(e2, qs, this.h);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"),
      li(n2, "IMAGE:input_image"),
      li(n2, "NORM_RECT:norm_rect"),
      fi(n2, "CLASSIFICATIONS:classifications"),
      n2.o(e2),
      _i(t2, n2),
      this.g.attachProtoListener("classifications", (t3, e3) => {
        ((this.j = (function (t4) {
          const e4 = {
            classifications: bn(t4, Qi, 1).map((t5) => {
              var _a2;
              return mo(
                ((_a2 = _n(t5, Fi, 4)) == null ? void 0 : _a2.g()) ?? [],
                Fn(Sn(t5, 2)),
                xn(t5, 3) ?? ""
              );
            }),
          ...
          return (
            null != Te(tn(t4, 2)) && (e4.timestampMs = Fn(Te(tn(t4, 2)))),
            e4
          );
        })(ns(t3))),
          Bo(this, e3));
...
((rc.prototype.classifyForVideo = rc.prototype.ta),
  ...
  (rc.createFromModelPath = function (t2, e2) {
...
var ic = class extends Ra {
  ...
  o(t2) {
    var e2 = this.h,
      n2 = _n(this.h, fs, 2);
    return (
      (n2 = n2 ? n2.clone() : new fs()),
      void 0 !== t2.l2Normalize
        ? Mn(n2, 1, t2.l2Normalize)
  ...
  m() {
    ...
    In(e2, Zs, this.h);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"),
      li(n2, "IMAGE:image_in"),
      li(n2, "NORM_RECT:norm_rect"),
      fi(n2, "EMBEDDINGS:embeddings_out"),
      n2.o(e2),
      _i(t2, n2),
      this.g.attachProtoListener("embeddings_out", (t3, e3) => {
        ((t3 = hs(t3)),
          (this.embeddings = (function (t4) {
            return {
              embeddings: bn(t4, ss, 1).map((t5) => {
                var _a2, _b;
                const e4 = {
                  headIndex: Fn(Sn(t5, 3)) ?? -1,
                  headName: xn(t5, 4) ?? "" ?? "",
                };
                if (void 0 !== vn(t5, rs, gn(t5, 1)))
                  ((t5 = cn((t5 = _n(t5, rs, gn(t5, 1))), 1, me)),
                    (e4.floatEmbedding = t5));
                else {
                  const n3 = new Uint8Array(0);
                  e4.quantizedEmbedding =
                    ((_b =
                      (_a2 = _n(t5, is, gn(t5, 2))) == null
                        ? void 0
                        : _a2.oa()) == null
                      ? void 0
                      : _b.qa()) ?? n3;
...
var cc = class extends Ra {
  ...
  o(t2) {
    return (
      void 0 !== t2.displayNamesLocale
        ? nn(this.h, 2, Se(t2.displayNamesLocale))
  ...
  V() {
    !(function (t2) {
      ...
      1 === e2.length &&
        (
          ((_b = (_a2 = _n(e2[0], ni, 7)) == null ? void 0 : _a2.l()) == null
            ? void 0
  ...
  m() {
    ...
    In(e2, io, this.h);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph"),
      li(n2, "IMAGE:image_in"),
      li(n2, "NORM_RECT:norm_rect"),
      n2.o(e2),
      _i(t2, n2),
      ...
      this.outputConfidenceMasks &&
        (bi(t2, "confidence_masks"),
        fi(n2, "CONFIDENCE_MASKS:confidence_masks"),
        No(this, "confidence_masks"),
        this.g.Y("confidence_masks", (t3, e3) => {
          ((this.confidenceMasks = t3.map((t4) => Ca(this, t4, !this.j))),
            Bo(this, e3));
        }),
      ...
      this.outputCategoryMask &&
        (bi(t2, "category_mask"),
        fi(n2, "CATEGORY_MASK:category_mask"),
        No(this, "category_mask"),
        this.g.X("category_mask", (t3, e3) => {
      ...
      bi(t2, "quality_scores"),
      fi(n2, "QUALITY_SCORES:quality_scores"),
...
((cc.prototype.getLabels = cc.prototype.Da),
  ...
  (cc.createFromModelPath = function (t2, e2) {
...
var Lc = class extends Ra {
  ...
  ba(t2, e2, n2, r2) {
    ...
    if (e2.keypoint) {
      var a2 = new bc();
      (Mn(a2, 3, true),
        Pn(a2, 1, e2.keypoint.x),
        Pn(a2, 2, e2.keypoint.y),
        An(s2, 5, kc, a2));
    } else {
      if (!e2.scribble)
    ...
    (kn(r2, Tc, s2),
      this.g.addProtoToStream(r2.g(), "drishti.RenderData", "roi_in", n2),
      Pa(this, t2, i2));
    t: {
      try {
        const t3 = new hc(
...
((Lc.prototype.segment = Lc.prototype.ba),
  ...
  (Lc.createFromModelPath = function (t2, e2) {
...
var Mc = class extends Ra {
  constructor(t2, e2) {
    (super(new La(t2, e2), "input_frame_gpu", "norm_rect", false),
      (this.j = { detections: [] }),
      (this.h = new so()),
      (t2 = new vs()),
      En(this.h, 0, 1, t2));
  ...
  m() {
    ...
    In(e2, oo, this.h);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.ObjectDetectorGraph"),
      li(n2, "IMAGE:input_frame_gpu"),
      li(n2, "NORM_RECT:norm_rect"),
      fi(n2, "DETECTIONS:detections"),
      n2.o(e2),
      _i(t2, n2),
...
((Mc.prototype.detectForVideo = Mc.prototype.G),
  ...
  (Mc.createFromModelPath = async function (t2, e2) {
...
var Ic = class extends Ra {
  ...
  m() {
    ...
    (wi(t2, "image_in"),
      wi(t2, "norm_rect"),
      bi(t2, "normalized_landmarks"),
      bi(t2, "world_landmarks"),
      bi(t2, "segmentation_masks"));
    const e2 = new ni();
    In(e2, po, this.h);
    const n2 = new di();
    (ui(n2, "mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph"),
      li(n2, "IMAGE:image_in"),
      li(n2, "NORM_RECT:norm_rect"),
      fi(n2, "NORM_LANDMARKS:normalized_landmarks"),
      fi(n2, "WORLD_LANDMARKS:world_landmarks"),
      n2.o(e2),
      _i(t2, n2),
      Uo(this, t2),
      ...
      this.outputSegmentationMasks &&
        (fi(n2, "SEGMENTATION_MASK:segmentation_masks"),
        No(this, "segmentation_masks"),
        this.g.Y("segmentation_masks", (t3, e3) => {
